...
class VCControl(commands.Cog):
    ...
    async def send_panel(self):
        ...
        channel = self.bot.get_channel(1362754109454680225)  # Replace with your channel ID
        if channel is None:
            return
    ...
    async def on_voice_state_update(self, member, before, after):
        # Check if user just joined the trigger VC
        target_channel_id = 1364639518279467079  # VC that triggers new VC creation
        category_id = 1359208824497639424       # Replace with your category ID where VCs are created
