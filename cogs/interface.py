...
class VCControlView(discord.ui.View):
    ...
    async def rename_vc(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("Please use Discord's official rename feature in the voice channel settings.", ephemeral=True)
    ...
    async def transfer_vc(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("Please use Discord's official transfer ownership feature in the voice channel settings.", ephemeral=True)
