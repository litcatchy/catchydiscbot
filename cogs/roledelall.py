...
class RoleDelete(commands.Cog):
    ...
    async def rdall(self, ctx):
        ...
        estimated = count  # 1 second per deletion
        ...
        final_embed = discord.Embed(
            description=f"<:success:1346853488738566175> `{len([r for r in reserves if r.startswith('**Role deleted**')])}` roles have been deleted.",
